        ...
        {isOpen && (
          ...
          >
            <div className="flex flex-col gap-6">
              ...
              <MobileNavLink label="Serviços" onClick={() => setIsOpen(false)} />
              <MobileNavLink label="Resultados" onClick={() => setIsOpen(false)} />
              <MobileNavLink label="Depoimentos" onClick={() => setIsOpen(false)} />
