...
export default function Hero() {
  return (
    <section className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden tech-grid pt-32 pb-20">
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl">
        ...
        >
          Você está <span className="text-brand-gold">perdendo dinheiro</span> todos os dias por estar invisível no digital.
        </motion.h1>
        ...
        >
          Soluções digitais que fazem seu negócio <span className="text-white font-bold">crescer de verdade</span>. A NexusWay transforma empresas locais em máquinas de vendas atraindo clientes e aumentando o faturamento.
        </motion.p>
