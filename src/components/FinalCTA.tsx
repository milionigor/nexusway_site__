  ...
  return (
    <section className="py-32 bg-brand-dark px-4 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          Quantos clientes você já <span className="text-brand-gold">perdeu hoje</span> por não estar bem posicionado?
        </motion.h2>
        
        <p className="text-brand-gray text-xl md:text-2xl mb-16 max-w-3xl mx-auto font-light leading-relaxed">
          Enquanto você decide, seus concorrentes estão investindo e crescendo. A pergunta é simples: <span className="text-white font-bold">você vai continuar invisível ou vai começar a crescer agora?</span>
        </p>
